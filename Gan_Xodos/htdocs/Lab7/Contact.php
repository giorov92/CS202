...
<body>
    ...
    <main>
        <section class="main-padding bg-color bg-color-helper-standard">
            <div class="container contact">
                ...
                <div>
                    <form class="contactform" method="post" action="hotel.php" onsubmit="return formValidator()"
                        and autocomplete>
                        ...
                        <textarea name="message" id="textarea" rows="10" cols="30"></textarea><br>
                        <br>
